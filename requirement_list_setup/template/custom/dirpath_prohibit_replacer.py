from requirement_list.base_dirpath_prohibit_replacer import BaseDirPathProhibitReplacer
from requirement_list.common_prohibit_replacer import CommonProhibitReplacer

class DirPathProhibitReplacer(BaseDirPathProhibitReplacer, CommonProhibitReplacer):
    """ ディレクトリパス用禁則文字列置換クラス
    """
    #
    # protectedメソッド

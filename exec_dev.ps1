...
function Invoke-Batch {
    param (
        ...
        # [string]$basePath = "your-project-base-path",
        # [string]$projectPathName,
        # [string]$requirementListFolder = "your-requirement-list-folder",
        # [string]$documentFolder = "your-document-folder"
        [string]$project
    )
